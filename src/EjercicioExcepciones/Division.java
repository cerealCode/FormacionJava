...
public class Division {
	...
	public static void main(String[] args) {
		...
		System.out.println("Vamos a realizar una divisi�n, introduce el numerador");
		numerador = consola.nextInt();
		System.out.println("Ahora introduce el denominador");
		denominador = consola.nextInt();
		
		//Realizamos la operaci�n pero controlando la posibilidad de que ocurra un error al intentar dividir
		try {
			resultado = numerador / denominador;
			//Si va bien, mostramos el resultado
			System.out.println("El resultado es " + resultado);
		} catch (Exception e) {
			//Si salta una excepci�n al intentar dividir, mostramos el mensaje con el error producido
